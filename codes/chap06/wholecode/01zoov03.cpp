...
protected:
    int wingSpan;
public:
    CBird(char *strName = "", int a = 0, int w = 0, int ws = 0): CAnimal(strName, a, w)
    {
        wingSpan = ws;
    }
    void Show()
...
protected:
    int power;
public:
    CHorse(char *strName = "", int a = 0, int w = 0, int pow = 0): CAnimal(strName, a, w)
    {
        power = pow;
    }
    void Show()
...
class CBull: public CAnimal
{
    int power;
public:
    CBull(char *strName = "", int a = 0, int w = 0, int pow = 0): CAnimal(strName, a, w)
    {
        power = pow;
    }
    void Show()
